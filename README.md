...
- Display basic information about each movie
...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/your-username/tba-movies-website.git
2. Install dependencies:
    ```bash
    cd tba-movies-website
    npm install
3. Obtain an API key from OMDb API and replace the API_URL last part in App.js with your API key.

# Acknowledgements
* JavaScript Mastery YouTube Channel - [Link to the tutorial used for creating this project.](https://youtu.be/b9eMGE7QtTk?si=tKC1U0Dhyur9MhjX)
